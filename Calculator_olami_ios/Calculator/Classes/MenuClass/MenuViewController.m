...
- (void)viewDidLoad {
    ...
    _headImage = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"333.png"]];
    ...
    CGRect rect = CGRectMake((280- 72)/2, 55, 72, 72);
    _headButton.frame = rect;
    _headImage.frame = CGRectMake(0, 0, 72, 72);
    [_headButton addSubview:_headImage];
    CGFloat marginX = 15;
    _usrAccountLabel.frame = CGRectMake(marginX, CGRectGetMaxY(_headButton.frame) + marginX, 280- marginX * 2, marginX);
    _lineView.frame = CGRectMake(marginX, CGRectGetMaxY(_usrAccountLabel.frame)+30, 280- marginX * 2, 0.5);
    ...
    _leftTableView.frame = CGRectMake(marginX, tablView_top, self.view.frame.size.width - marginX * 2, 88);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        [[self sliderViewController].sliderNavigationController pushViewController:skinVC animated:YES];
    }
}
